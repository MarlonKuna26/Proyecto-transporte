...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="page-gradient min-h-screen flex">
      {/* Mobile overlay */}
      {sidebarOpen && (
        <div
      ...
      >
        ...
        <div className="p-6 border-b border-white/5">
          <Link to="/dashboard" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-dark-400">Transporte estudiantil</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-white/5">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-400 to-accent-400 flex items-center justify-center text-sm font-bold text-white">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        {/* Mobile header */}
        <header className="lg:hidden sticky top-0 z-30 bg-dark-950/80 backdrop-blur-xl border-b border-white/5 px-4 py-3 flex items-center justify-between">
          <button
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white">U-Ride</span>
          </div>
