      ...
      {editMode && (
        <form onSubmit={handleSaveProfile} className="glass-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div><label className="block text-sm text-dark-500 mb-1">Teléfono</label><input className="input-field" value={editData.phone || ''} onChange={e => setEditData({ ...editData, phone: e.target.value })} placeholder="+57 300..." /></div>
