...
const UserProfileDTO_1 = require("../../src/modules/users/application/dtos/UserProfileDTO");
describe('UserProfileDTO - Integration', () => {
    ...
    it('debe integrarse correctamente en flujo de actualización de perfil', () => {
        ...
        const dto = new UserProfileDTO_1.UpdateProfileDTO(input);
    ...
    it('debe mapear respuesta completa como en API real', () => {
        ...
        const response = new UserProfileDTO_1.ProfileResponseDTO(rawFromDbOrService);
    ...
    it('debe manejar datos incompletos como vendrían del backend', () => {
        ...
        const response = new UserProfileDTO_1.ProfileResponseDTO(partialData);
    ...
    it('debe soportar valores null provenientes de base de datos', () => {
        ...
        const response = new UserProfileDTO_1.ProfileResponseDTO(dbResult);
        expect(response.career).toBeNull();
        expect(response.photoUrl).toBeNull();
        expect(response.phone).toBeNull();
    });
});
//# sourceMappingURL=UserProfileDTO.test.js.map